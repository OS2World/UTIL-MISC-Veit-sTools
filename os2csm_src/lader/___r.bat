...
c:\bp\bin\tasm /n /t /oi /m /ml /Dnomemdisk /Dnodebug lader_%2.tas, %tmp%\lader_%2.obj > err.pas
type err.pas
...
if exist ..\os2csm.vk\bin\%2\os2csmr.bin del ..\os2csm.vk\bin\%2\os2csmr.bin
exe2bin %tmp%\lader_%2.exe ..\os2csm.vk\bin\%2\os2csmr.bin
if not exist ..\os2csm.vk\bin\%2\os2csmr.bin goto fehler
